...
-- Equation(s):
-- \counter[2]~2_combout\ = counter(2) $ (((counter(0) & (!\ext_ena_n~combout\ & counter(1)))))
...
-- Equation(s):
-- \counter[3]~3_combout\ = (!\ext_ena_n~combout\ & (counter(1) & (counter(0) & counter(2))))
...
-- Equation(s):
-- \Mux6~0_combout\ = (counter(2) & (!counter(1) & (counter(0) $ (!counter(3))))) # (!counter(2) & (counter(0) & (counter(1) $ (!counter(3)))))
...
-- Equation(s):
-- \Mux5~0_combout\ = (counter(1) & ((counter(0) & ((counter(3)))) # (!counter(0) & (counter(2))))) # (!counter(1) & (counter(2) & (counter(0) $ (counter(3)))))
...
-- Equation(s):
-- \Mux4~0_combout\ = (counter(2) & (counter(3) & ((counter(1)) # (!counter(0))))) # (!counter(2) & (!counter(0) & (counter(1) & !counter(3))))
...
-- Equation(s):
-- \Mux3~0_combout\ = (counter(1) & ((counter(2) & (counter(0))) # (!counter(2) & (!counter(0) & counter(3))))) # (!counter(1) & (!counter(3) & (counter(2) $ (counter(0)))))
...
-- Equation(s):
-- \Mux2~0_combout\ = (counter(1) & (((counter(0) & !counter(3))))) # (!counter(1) & ((counter(2) & ((!counter(3)))) # (!counter(2) & (counter(0)))))
...
-- Equation(s):
-- \Mux1~0_combout\ = (counter(2) & (counter(0) & (counter(1) $ (counter(3))))) # (!counter(2) & (!counter(3) & ((counter(0)) # (counter(1)))))
...
-- Equation(s):
-- \Mux0~0_combout\ = (counter(0) & ((counter(3)) # (counter(2) $ (counter(1))))) # (!counter(0) & ((counter(1)) # (counter(2) $ (counter(3)))))
