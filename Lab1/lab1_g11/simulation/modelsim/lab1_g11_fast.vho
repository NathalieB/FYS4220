...
-- Equation(s):
-- \Mux6~0_combout\ = (\SW~combout\(2) & (!\SW~combout\(1) & (\SW~combout\(0) $ (!\SW~combout\(3))))) # (!\SW~combout\(2) & (\SW~combout\(0) & (\SW~combout\(1) $ (!\SW~combout\(3)))))
...
-- Equation(s):
-- \Mux4~0_combout\ = (\SW~combout\(2) & (\SW~combout\(3) & ((\SW~combout\(1)) # (!\SW~combout\(0))))) # (!\SW~combout\(2) & (!\SW~combout\(0) & (\SW~combout\(1) & !\SW~combout\(3))))
...
-- Equation(s):
-- \Mux1~0_combout\ = (\SW~combout\(0) & (\SW~combout\(3) $ (((\SW~combout\(1)) # (!\SW~combout\(2)))))) # (!\SW~combout\(0) & (\SW~combout\(1) & (!\SW~combout\(2) & !\SW~combout\(3))))
...
-- Equation(s):
-- \Mux0~0_combout\ = (\SW~combout\(0) & ((\SW~combout\(3)) # (\SW~combout\(1) $ (\SW~combout\(2))))) # (!\SW~combout\(0) & ((\SW~combout\(1)) # (\SW~combout\(2) $ (\SW~combout\(3)))))
